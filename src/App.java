...
public class App {
    ...
    public static void final1(Personagem Edward) {
        msgFim();
        System.out.println(
        ...
        Edward.exibirEnergia(true);
        }
        
    public static void final2(Personagem Joao, Personagem Edward) {
        msgFim();
        System.out.println(
    ...
    public static void final3(Personagem Joao,Personagem Edward) {
        msgFim();
        System.out.println(
